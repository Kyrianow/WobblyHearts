execute as @a[scores={wobblyhearts_deaths=-10}] run attribute @s minecraft:generic.max_health base set 40
execute as @a[scores={wobblyhearts_deaths=-9}] run attribute @s minecraft:generic.max_health base set 38
execute as @a[scores={wobblyhearts_deaths=-8}] run attribute @s minecraft:generic.max_health base set 36
execute as @a[scores={wobblyhearts_deaths=-7}] run attribute @s minecraft:generic.max_health base set 34
execute as @a[scores={wobblyhearts_deaths=-6}] run attribute @s minecraft:generic.max_health base set 32
execute as @a[scores={wobblyhearts_deaths=-5}] run attribute @s minecraft:generic.max_health base set 30
execute as @a[scores={wobblyhearts_deaths=-4}] run attribute @s minecraft:generic.max_health base set 28
execute as @a[scores={wobblyhearts_deaths=-3}] run attribute @s minecraft:generic.max_health base set 26
execute as @a[scores={wobblyhearts_deaths=-2}] run attribute @s minecraft:generic.max_health base set 24
execute as @a[scores={wobblyhearts_deaths=-1}] run attribute @s minecraft:generic.max_health base set 22
...
execute as @a[scores={wobblyhearts_apple=1..}] unless score @s wobblyhearts_deaths matches ..-10 run scoreboard players remove @s wobblyhearts_deaths 1
execute as @a[scores={wobblyhearts_apple=1..}] if score @s wobblyhearts_deaths matches -10 run tellraw @s ["",{"text":"-----------------","bold":true,"color":"yellow"},{"text":"\n"},{"text":"Heart limit reached","bold":true,"color":"gold"},{"text":"\n"},{"text":"-----------------","bold":true,"color":"yellow"}]
